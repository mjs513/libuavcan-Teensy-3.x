#ifndef	SUBSCRIBERIMU_HPP
#define	SUBSCRIBERIMU_HPP
...
void initSubscriberIMU(Node<NodeMemoryPoolSize> *node)
{
  // create a subscriber
  ...
  {
    Serial.println("Unable to start IMU subscriber!");
  } else {
    Serial.println("IMU Subscriber Started");
